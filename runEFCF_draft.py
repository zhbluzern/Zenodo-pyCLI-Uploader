...
data = pd.read_excel(r'EFCF/draft.xlsx',  header=0)
...
df.to_excel(f"EFCF/drafted_{timestamp}.xlsx", index=False, engine="openpyxl")
df.to_excel("EFCF/drafted.xlsx", index=False, engine="openpyxl")
