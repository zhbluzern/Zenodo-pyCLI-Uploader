...
data = pd.read_excel(r'RoRa/publish.xlsx',  header=0)
...
#    https://inveniordm.docs.cern.ch/reference/metadata/#description-0-1
    ...
    df.at[index, "published"] = "True"
     ...
     # ADD TO COMMUNITIES
    print(zenodo.addRectoCommunity(recId, {"communities": [{"id": "roracom"}]}))

timestamp = datetime.now().strftime("%Y-%m-%d-%H%M")
df.to_excel(f"RoRa/published_{timestamp}.xlsx", index=False, engine="openpyxl")
