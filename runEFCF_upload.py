...
data = pd.read_excel(r'EFCF/upload.xlsx',  header=0)
...
#    https://inveniordm.docs.cern.ch/reference/metadata/#description-0-1
    ...
    print(handleFiles.uploadFile(zenodo,listOfFiles,existingDraft,"EFCF/files/"))

  #  print(existingDraft)
        
timestamp = datetime.now().strftime("%Y-%m-%d-%H%M")
df.to_excel(f"EFCF/uploaded_{timestamp}.xlsx", index=False, engine="openpyxl")
